...
export const TaskTool = Tool.define(
  ...
  Effect.gen(function* () {
    ...
    const weaveEvent = yield* WeaveEvent.Service
    ...
    const run = Effect.fn("TaskTool.execute")(function* (
      ...
      yield* weaveEvent
        .append({
          ...
          role: "manager",
          type: session ? "dispatch.resume" : "dispatch.solver",
          payload: {
            subagent_type: params.subagent_type,
            description: params.description,
      ...
      const inject = Effect.fn("TaskTool.injectBackgroundResult")(function* (
        ...
        yield* weaveEvent
          .append({
            sessionID: ctx.sessionID,
            role: "manager",
            type: state === "completed" ? "dispatch.background.completed" : "dispatch.background.error",
            payload: {
              subagent_type: params.subagent_type,
              description: params.description,
              next_session_id: nextSession.id,
